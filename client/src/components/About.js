  ...
  return (
    <div className='flex-container'>
      <div className="about-heading">
        ...
        <div>
        <p>
          Spotify Playlist Analyzer is a tool designed 
        </p>
        <p>
          This website was developed using the <a href="https://developer.spotify.com/documentation/web-api" rel="noreferrer" target="_blank">Spotify Web API</a> 
          to display information about any public Spotify playlist.
        </p>
      </div>
      <div>
        <h2>
